...
-   oral_postextub: Time to first oral feeding after extubation (days)
    - This was a new variable created by subtracting the time to the final extubation after sugery (extub_days) from the time to first postopative oral feeding (enteral_d_oral_initiate_day)
